...
# Simulation Class
class Simulation:
    def __init__(self, start_date, delta_t_days, initial_population_male, initial_population_female,total_days):
        # Initial settings
        ...
        self.death_female =[]
        self.death_male=[]
        self.immigration_female=[]
        self.immigration_male=[]
        self.emigration_female=[]
        self.emigration_male=[]
    ...
    def event_emigration_male(self):
        ...
        self.emigration_male.append(change_population_male)
    ...
    def event_emigration_female(self):
        ...
        self.emigration_female.append(change_population_female)
    ...
    def event_immigration_male(self):
        ...
        self.population_male += change_population_male
        self.immigration_male.append(change_population_male)
    ...
    def event_immigration_female(self):
        ...
        self.population_female += change_population_female
        self.immigration_female.append(change_population_female)
    ...
    def run_cycle(self):
        ...
        if self.current_date == self.end_date:
            print("female death rate:",self.death_female[-1])
            print("male death rate:",self.death_male[-1]) 
            print("female birth rate:",self.birth_female[-1])
            print("male birth rate:",self.birth_male[-1])
            print("female immigration rate:",self.immigration_female[-1])
            print("male immigration rate:",self.immigration_male[-1])
            print("female emigration rate:",self.emigration_female[-1])
            print("male emigration rate:",self.emigration_male[-1])
